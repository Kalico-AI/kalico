...
//    private List<ProjectEntity> blogPostEntities;
...
//        projectIds = blogPostEntities.stream()
//          .map(ProjectEntity::getId)
//          .collect(Collectors.toList());
//
//        createRecipeImages(projectIds);
//        createVideoContent(projectIds);
//        createIngredients(projectIds);
...
//  }
//
//  private List<ProjectEntity> createBlogPosts(int count) {
...
//    }
//
//    private void createRecipeImages(List<Long> projectIds) {
...
//    }
//
//  private void createVideoContent(List<Long> projectIds) {
//      List<MediaContentEntity> entities = new ArrayList<>();
//      for (Long projectId : projectIds) {
...
//        entities.add(entity);
//      }
//      mediaContentRepo.saveAll(entities);
//  }
//
//  private void createIngredients(List<Long> projectIds) {
