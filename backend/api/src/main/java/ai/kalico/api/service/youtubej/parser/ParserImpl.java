...
import com.kalico.api.service.youtubej.YoutubeException.BadPageException;
import com.kalico.api.service.youtubej.cipher.Cipher;
import com.kalico.api.service.youtubej.cipher.CipherFactory;
...
import com.kalico.api.service.youtubej.model.search.SearchResultChannelDetails;
...
import com.kalico.api.service.youtubej.model.search.SearchResultPlaylistDetails;
import com.kalico.api.service.youtubej.model.search.SearchResultShelf;
...
import com.kalico.api.service.youtubej.model.videos.formats.Itag;
...
import com.kalico.api.service.youtubej.extractor.Extractor;
...
public class ParserImpl implements Parser {
    ...
    private VideoInfo parseVideoWeb(String videoId, YoutubeCallback<VideoInfo> callback) throws YoutubeException {
        ...
        if (!playerResponse.containsKey("streamingData") && !playerResponse.containsKey("videoDetails")) {
            throw new BadPageException("streamingData and videoDetails not found");
        }
